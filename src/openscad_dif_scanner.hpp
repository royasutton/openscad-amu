...
class ODIF_Scanner : public yyFlexLexer{
  ...
  //////////////////////////////////////////////////////////////////////////////
    ...
    // must call before calling scan().
    //! update environment variable map.
    void update_gevm(void);

    // scan() implementation generated by flex.
    // see #define YY_DECL in lexer source.
  ...
  //////////////////////////////////////////////////////////////////////////////
    ...
    //! get the path to the OpenSCAD executable.
    std::string get_openscad_path(void) { return openscad_path; }

    //! set the file extension used for OpenSCAD files.
    void set_openscad_ext(const std::string& s) { openscad_ext = s; }
    //! get the file extension used for OpenSCAD files.
  ...
  //////////////////////////////////////////////////////////////////////////////
    ...
    std::string openscad_path;              //!< path to OpenSCAD.
